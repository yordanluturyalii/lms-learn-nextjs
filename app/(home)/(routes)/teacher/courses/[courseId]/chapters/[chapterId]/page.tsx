...
import {
    ChapterTitleForm
} from "@/app/(home)/(routes)/teacher/courses/[courseId]/chapters/[chapterId]/_components/chapter-title-form";
import {
    ChapterDescriptionForm
} from "@/app/(home)/(routes)/teacher/courses/[courseId]/chapters/[chapterId]/_components/chapter-description-form";
import {
    ChapterAccessForm
} from "@/app/(home)/(routes)/teacher/courses/[courseId]/chapters/[chapterId]/_components/chapter-access-form";
import {
    ChapterVideoForm
} from "@/app/(home)/(routes)/teacher/courses/[courseId]/chapters/[chapterId]/_components/chapter-video-form";
...
const ChapterIdPage = async ({ params }: { params: { courseId: string, chapterId: string } }) => {
    ...
    if (!chapter) return redirect('/home')
    ...
    return (
        ...
        {!chapter.isPublished && (
            <Banner
             variant={"warning"} label={"This chapter is unpublished. It will not be visible in the course"}
            />
        )}
            <div className={"p-6"}>
